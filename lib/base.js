...
class BaseConnection {
  ...
  */
  ...
  /**
   * Extends path(-s) from project(/module) root.
   *
   * @arguments {String} path1...pathN
   * @return {String} path
   * @public
   */
  extendPath () {
...
/**
 * Alias for #extendPath()
 *
 * @arguments {String} path1...pathN
 * @return {String} path
 * @public
 */
BaseConnection.prototype.expandPath = BaseConnection.prototype.extendPath
